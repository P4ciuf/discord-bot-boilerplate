...
```bash
git clone [[https://github.com/your-username/discord-bot-boilerplate.git](https://github.com/P4ciuf/discord-bot-boilerplate)](https://github.com/P4ciuf/discord-bot-boilerplate)
